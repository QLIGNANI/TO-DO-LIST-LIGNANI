    ...
    <Formik
      ...
      onSubmit={(values, { setSubmitting }) => {
        if (isUpdating) handleSaveUpdate(todos.indexOf(currentTodo), values)
          ...
          handleSubmit(values, {
            setSubmitting,
            resetForm: formik.current.resetForm,
          })
        setSubmitting(false)
        onCloseModal()
      }}
        ...
        <Form className="">
          <div className="p-6">
            ...
            <div className="flex flex-col space-y-6">
              <div className="relative my-6">
                ...
                />
                <label htmlFor="task" className={`${styles.inputLabel}`}>
                  Tâche
                </label>
                <ErrorMessage
                  name="task"
          ...
          <div className={styles.buttonContainer}>
            <Button
              ...
              text="Annuler"
              onClick={() => onCloseModal({ clearForm: true })}
            />
            ...
            <Button
              ...
              text={isUpdating ? "Enregistrer" : "Créer"}
            />
          </div>
        </Form>
      )}
    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <div className={styles.card}>
          <div
            className={`shadow-wuiSlate-200 ring-wuiSlate-20 ${styles.cardContent}`}
          >
            <div className="w-full overflow-x-auto">
              <Button
                class={`d-inline-flex p-2 ${styles.primaryBtn}`}
                type="button"
      ...
      {isDialogModalOpen && (
        <Modal
          component={dialog}
          isModalOpen={isDialogModalOpen}
          onClose={() => onCloseModal({ dialog: true })}
          class="max-w-xs"
        />
      )}
    </div>
